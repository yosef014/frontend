  ...
  <div class="signup-popup" @click.prevent.stop="closeModal">
    <div class="signup-popup-modal" v-if="!isOpen" @click.stop>
      <div>
        ...
        <div class="btn-signup-facebook">
          <button class="signup-btn-facebook">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
        ...
        <div class="signup-form-separator">
          <span>OR</span>
        </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      close() {
        console.log("close from signup", this.close);
      },
    },
  };
</script>
